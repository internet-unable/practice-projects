...
class ReplyToCommentType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('replyToId', HiddenType::class, [
                'mapped' => false,
                'constraints' => [
                    new NotBlank(),
                ],
